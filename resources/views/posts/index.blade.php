        ...
        <div class="rounded-b-lg border-t border-gray-200 px-4 py-2">
            <ol class="flex justify-end gap-1 text-xs font-medium">
                @if ($posts->onFirstPage())
                    <li class="disabled "><span class="sr-only" >Prev Page</span></li>
                @else
        
                <li>
                    
                    <a href="{{ $posts->previousPageUrl() }}" class="inline-flex size-8 items-center justify-center rounded-sm border border-gray-100 bg-white text-gray-900">
                ...
                @endif
                <li>
                    <a href="{{ $posts->url(1) }}" class="block size-8 rounded-sm border border-gray-100 bg-white text-center leading-8 text-gray-900 fill-amber-600">1</a>
                </li>
                <li class="block size-8 rounded-sm border-blue-600 bg-blue-600 text-center leading-8 text-white">                    <a href="{{ $posts->url(2) }}" class="block size-8 rounded-sm border border-gray-100 bg-white text-center leading-8 text-gray-900">2</a>
                </li>
                <li>
                    <a href="{{ $posts->url(3) }}" class="block size-8 rounded-sm border border-gray-100 bg-white text-center leading-8 text-gray-900">3</a>
                </li>
                <li>
                    <a href="{{ $posts->url(4) }}" class="block size-8 rounded-sm border border-gray-100 bg-white text-center leading-8 text-gray-900">4</a>
                </li>
                <li>
                    <a href="{{ $posts->nextPageUrl() }}" class="inline-flex size-8 items-center justify-center rounded-sm border border-gray-100 bg-white text-gray-900">
